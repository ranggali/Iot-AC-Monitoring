...
# Batasan masalah:
 Pada sistem ini adalah sistem hanya melakukan pegiriman sinyal ke AC dan tidak terhubung langsung ke AC sehingga ketika sistem mengirimkan sinyal dan di dalam web terbaca AC Aktif, bisa saja keadaan aslinya tidak aktif.
# Jummlah User:
 Proyek ini hanya memiliki satu user yaitu Admin IT yang dapat mengakses seluruh halaman yang ada di dalam sistem web.
# Nama AC:
 Pada proyek ini AC yang dijadikan uji coba seperti Sharp, Daikin dan Samsung.
